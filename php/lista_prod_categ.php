			        ...
			        <div class="media-content">
			            <div class="content">
			              <p>
			                ...
			                <strong>LOTE:</strong> '.$rows['producto_codigo'].', <strong>FARMACÉUTICA:</strong> '.$rows['producto_farmace'].', <strong>PRECIO:</strong> Bs.'.$rows['producto_precio'].', <strong>STOCK:</strong> '.$rows['producto_stock'].', <strong>CATEGORIA:</strong> '.$rows['categoria_nombre'].'<br> <strong>F_INGRESO:</strong> '.$rows['producto_ingreso'].', <strong>F_VENCIMIENTO:</strong> '.$rows['fecha_venc'].', <strong>REGISTRADO POR:</strong> '.$rows['usuario_nombre'].' '.$rows['usuario_apellido'].'
			              </p>
			            </div>
